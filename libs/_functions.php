<?php
    ...
    function exist_routes($conn, $org, $thr, $des)
    {
        $sql = "SELECT * FROM `route` WHERE `Intial_station`='$org' AND `through`='$thr' AND`Final_Station`='$des'";
    ...
    function exist_buses($conn, $busid)
    {
    ...
    {
        $sql = "UPDATE bus SET bus_assigned=1 WHERE bus_no='$busno'";
        $result = mysqli_query($conn, $sql);
    }
